...
**For visual style direction**:
1. Use `guides/building-scrollytelling-pages.md` and adapt the visual system to your brand.
...
- `ui/web/animation-basics.md` - CSS animation fundamentals
