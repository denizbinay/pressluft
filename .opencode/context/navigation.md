...
└── project-intelligence/   # Living notes and decisions
```
...
**project/** - Project-specific context → `project/project-context.md`
**project-intelligence/** - Living project memory → `project-intelligence/navigation.md`
